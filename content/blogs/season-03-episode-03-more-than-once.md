...
description: "The Copycat Sprite reaches a room Byte never placed in the test."
longDescription: "A second sandbox run sends the Copycat Sprite past the expected room list. Jinx helps Byte sort facts, fears, and the first real boundary failure."
cardImage: "https://bl4ck4t.com/script-kitties-crowd.jpg"
tags: ["story", "script-kitties", "cybersecurity", "propagation", "season-3"]
readTime: 5
featured: false
