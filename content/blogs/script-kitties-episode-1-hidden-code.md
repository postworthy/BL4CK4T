...
description: "The Script Kitties crack their first encrypted BL4CK4T drop and open a path to bigger secrets in Cybertropolis."
longDescription: "In this pilot chapter, the Script Kitties decode their first message from the unseen mentor BL4CK4T using a Caesar cipher (shift 5). The win foreshadows their next lesson: public–private keys and Diffie–Hellman."
...
The rest of the crew crowded around the flickering screen: **Grimalkin**, **Byte**, **Whiskers**, **Cipher**, **Jinx**, and **Shadow**. They lived together in a warehouse converted into a hacker’s den, with walls stacked with old servers and neon wires snaking across the ceiling like vines.
