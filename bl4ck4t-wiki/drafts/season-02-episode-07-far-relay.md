...
created: 2026-05-27
updated: 2026-05-27
target_slug: season-02-episode-07-far-relay
tags: [season-2, script-kitties, far-relay, ledgerjack]
sources:
  - ../missions/season-02-episode-07-far-relay.md
  - ../production-bibles/season-02-the-seventy-five-cent-thread.md
canon_pages:
  - ../factions/far-relay.md
  - ../villains/ledgerjack.md
  - ../characters/jinx.md
  - ../characters/whiskers.md
  - ../characters/byte.md
---

# Season 2, Episode 7: The Far Relay

## Publication Frontmatter

```yaml
title: "The Far Relay"
slug: "season-02-episode-07-far-relay"
description: "The team finds a brokered shadow behind the borrowed access pattern."
longDescription: "The Threadboard shows that the borrowed door is connected to the Far Relay, a brokered channel where stolen project notes and access rumors move. Jinx learns that curiosity changes when someone starts selling what does not belong to them."
...
- World consistency: Far Relay and Ledgerjack match support canon.
- Lesson accuracy: market/broker layer is transformed and non-operational.
- Safety review: no marketplace mechanics or contacts appear.
