...
sources:
  - ../missions/season-03-episode-01-ninth-marker.md
canon_pages:
...
Final public copy promoted to `content/blogs/season-03-episode-01-ninth-marker.md`.
...
- World consistency: Ledger Lab and Threadboard continuity remain intact.
- Lesson accuracy: propagation is shown through story-level markers.
- Safety review: no real worm mechanics included.
