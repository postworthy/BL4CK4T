...
created: 2026-05-27
updated: 2026-05-27
target_slug: season-02-episode-01-seventy-five-cent-thread
tags: [season-2, script-kitties, investigation, ledger-lab]
sources:
  - ../missions/season-02-episode-01-seventy-five-cent-thread.md
...
# Season 2, Episode 1: The Seventy-Five Cent Thread

## Publication Frontmatter

```yaml
title: "The Seventy-Five Cent Thread"
slug: "season-02-episode-01-seventy-five-cent-thread"
description: "Jinx follows a tiny resource mismatch from the Hushline model into the Ledger Lab."
longDescription: "Season 2 begins when the Hushline model refuses to settle. A red -0.75 appears in the records, and Jinx follows the number into the Ledger Lab, where the smallest wrong line may be the only clue willing to speak."
cardImage: "https://bl4ck4t.com/script-kitties-crowd.jpg"
tags: ["story", "script-kitties", "cybersecurity", "investigation", "season-2"]
readTime: 7
featured: false
...
- World consistency: follows the Season 1 cliffhanger and introduces Ledger Lab as a shared-resource setting.
- Lesson accuracy: small anomalies can matter, but evidence comes before conclusions.
- Safety review: no intrusion method or abuse path appears.
