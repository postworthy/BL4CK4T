...
created: 2026-05-26
updated: 2026-05-26
target_slug: season-01-episode-06-tonebox-demo
tags: [season-1, script-kitties, tonebox, echo-grid]
sources:
  - ../missions/season-01-episode-06-tonebox-demo.md
...
# Season 1, Episode 6: The Tonebox Demo
...
- World consistency: Tonebox, Hushline preview, Row Rebels board, Signal Row, and BL4CK4T drops align with the production bible.
- Lesson accuracy: the episode explains models and assumptions without real system procedure.
- Safety review: no real tones, frequencies, device steps, or abuse process are included.
- TROPES.md validation: passed with `pnpm tropes:check bl4ck4t-wiki/drafts/season-01-episode-06-tonebox-demo.md`.
