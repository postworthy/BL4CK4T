...
created: 2026-05-27
updated: 2026-05-27
target_slug: season-02-episode-06-old-trust-paths
tags: [season-2, script-kitties, civic-learning-grid, trust]
sources:
  - ../missions/season-02-episode-06-old-trust-paths.md
  - ../production-bibles/season-02-the-seventy-five-cent-thread.md
canon_pages:
  - ../concepts/civic-learning-grid.md
...
# Season 2, Episode 6: Old Trust Paths

## Publication Frontmatter

```yaml
title: "Old Trust Paths"
slug: "season-02-episode-06-old-trust-paths"
description: "The Threadboard follows the mismatch across the Civic Learning Grid's older connections."
longDescription: "The case leaves the Ledger Lab and crosses library terminals, museum kiosks, and old research relays. Grimalkin maps the trust paths, Cipher removes a false pattern, and Shadow finds the physical clue that keeps the thread intact."
cardImage: "https://bl4ck4t.com/script-kitties-crowd.jpg"
tags: ["story", "script-kitties", "cybersecurity", "systems", "season-2"]
readTime: 7
featured: false
...
- World consistency: Civic Learning Grid trust paths match support canon.
- Lesson accuracy: connected systems can inherit risk through old relationships.
- Safety review: no route mechanics or intrusion steps appear.
