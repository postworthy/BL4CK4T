...
created: 2026-05-27
updated: 2026-05-27
target_slug: season-02-episode-03-borrowed-door
tags: [season-2, script-kitties, account-misuse, investigation]
sources:
  - ../missions/season-02-episode-03-borrowed-door.md
  - ../production-bibles/season-02-the-seventy-five-cent-thread.md
canon_pages:
  - ../concepts/account-misuse.md
  - ../concepts/intrusion-detection.md
...
# Season 2, Episode 3: The Borrowed Door

## Publication Frontmatter

```yaml
title: "The Borrowed Door"
slug: "season-02-episode-03-borrowed-door"
description: "A warm terminal and a strange timing pattern turn the -0.75 clue into behavior."
longDescription: "Jinx, Shadow, Cipher, and Grimalkin return to the Ledger Lab after hours. A terminal that should be cold, a print slip no one claimed, and repeated timing give the team a new phrase for the case: the Borrowed Door."
...
- World consistency: Ledger Lab rules and Ms. Vale's privacy limits remain intact.
- Lesson accuracy: defender-observed misuse indicators stay non-operational.
- Safety review: no credential, bypass, or login steps appear.
