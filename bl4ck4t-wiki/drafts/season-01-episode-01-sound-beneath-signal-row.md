...
created: 2026-05-26
updated: 2026-05-26
target_slug: season-01-episode-01-sound-beneath-signal-row
tags: [season-1, script-kitties, signal-row, echo-grid]
sources:
  - ../missions/season-01-episode-01-sound-beneath-signal-row.md
...
# Season 1, Episode 1: The Sound Beneath Signal Row
...
- World consistency: Signal Row, The Hideout, BL4CK4T drops, and Cybertropolis infrastructure match the wiki.
- Lesson accuracy: the episode introduces hidden signals, system mapping, and the message-command distinction without real telecom procedure.
- Safety review: no real tones, frequencies, device steps, or abuse process are included.
- TROPES.md validation: passed with `pnpm tropes:check bl4ck4t-wiki/drafts/season-01-episode-01-sound-beneath-signal-row.md`.
