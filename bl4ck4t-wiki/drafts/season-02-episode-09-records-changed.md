...
created: 2026-05-27
updated: 2026-05-27
target_slug: season-02-episode-09-records-changed
tags: [season-2, script-kitties, finale, incident-response]
sources:
  - ../missions/season-02-episode-09-records-changed.md
  - ../production-bibles/season-02-the-seventy-five-cent-thread.md
canon_pages:
  - ../concepts/incident-reporting.md
  - ../concepts/anomaly-investigation.md
  - ../locations/ledger-lab.md
  - ../factions/glass-bureau.md
  - ../characters/jinx.md
  - ../characters/pixel.md
...
# Season 2, Episode 9: What The Records Changed

## Publication Frontmatter

```yaml
title: "What The Records Changed"
slug: "season-02-episode-09-records-changed"
description: "The Ledger Lab changes how the city listens to small anomalies, and Pixel finds the next strange thread."
longDescription: "Season 2 closes as the Ledger Lab, Glass Bureau, and Civic Learning Grid change how they preserve and share anomaly reports. Jinx finishes the case as an investigator, and Pixel's contained toy process opens the door to Season 3."
cardImage: "https://bl4ck4t.com/script-kitties-crowd.jpg"
tags: ["story", "script-kitties", "cybersecurity", "incident-response", "season-2"]
readTime: 7
featured: false
...
- World consistency: Ledger Lab, Glass Bureau, Threadboard, Far Relay, and Season 3 bridge all align with the production bible.
- Lesson accuracy: aftermath focuses on changed reporting and response practice.
- Safety review: self-copying is described only as a contained toy simulation without mechanics.
