...
# Season 2: The Seventy-Five Cent Thread

## Logline

A tiny accounting mismatch in Cybertropolis becomes a thread leading through terminals, modems, spies, and disbelief.

## Historical Inspiration

The Cuckoo's Egg and the Hanover hackers.
...
- Character theme: Jinx learns disciplined investigation.
- Ethical theme: small anomalies deserve careful attention.

## Core Lessons

- Logs tell stories.
- Tiny clues can matter.
- Evidence beats panic.
- Institutions may not understand new kinds of risk.

## Episode Shape

1. Jinx finds a tiny mismatch no one else cares about.
2. Byte helps create safe logging.
3. Grimalkin maps the trail.
...
- Do not describe real intrusion steps.
- Emphasize detection, evidence, and reporting.
